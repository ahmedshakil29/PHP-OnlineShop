    ...
    <section>
        <div class="gridmain">
            ...
            <section>
                <div class="grid3">
                    <b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Password:
                    </b><input type="password" id="password" style="width:140px" />
                </div>
            </section>
            <Section>
                <div class="grid1">
            ...
            <section>
                <div class="grid3">
                    <button type="submit" onclick="checkform()" style="width:100px">Sign
                        Up</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                </div>
            </section>
            ...
            function checkform() {
                ...
                if (nam == "") {
                    ...
                    alert("Enter Address");
                } else if (password != document.getElementById("conpass").value || password == "" || document
                    .getElementById("conpass").value == "") {
                    alert("Enter correct password in both place");
                } else {
                    window.location.href = "insertUser.php?name=" + nam + "&email=" + emal + "&gender=" + gndr +
                        "&phone=" + phno + "&address=" + address + "&password=" + password + "&ut_id=" + 2 +
                        "&pressed=Yes";
                }
            }
            </script>
